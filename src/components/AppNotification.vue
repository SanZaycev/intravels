...
export default {
  ...
  computed: {
    ...mapGetters('notification', ['active', 'text', 'closable', 'type']),
    isActive() {
      return this.active && !isEmptyString(this.text)
    }
  },
  methods: {
    ...mapActions('notification', ['close'])
  }
}
</script>
